...
export const AddItemForm = React.memo(function AddItemForm({
  ...
  const borderColor = error ? 'red' : defaultBorderColor;
...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, height: 40, borderWidth: 1, borderRadius: 6, paddingHorizontal: 10, marginRight: 8 },
  button: { justifyContent: 'center', alignItems: 'center', minWidth: 44, minHeight: 44 },
